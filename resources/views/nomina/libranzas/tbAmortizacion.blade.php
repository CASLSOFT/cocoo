    ...
    var vm = new Vue({
        ...
        methods: {
            limpiar(){
                ...
                this.fillAmortizacion.fecha_inic  = '';
                this.fillAmortizacion.fecha_final  = '';
            ...
            getAmortizaciones() {
                ...
                let url = '/nomina/tbamortizacion/'+ id + '/'+ category +'/?page=' +this.amortizaciones.current_page;
            ...
            getEdit(item) {
                ...
                this.fillAmortizacion.fecha_inic  = item.fecha_inic;
                this.fillAmortizacion.fecha_final  = item.fecha_final;
